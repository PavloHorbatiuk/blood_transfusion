			...
			<div className="container">
				<div className="content">
					<div className="wrapper">
						<h5 className="title_check">
							<span className="GreenSpan">Впевнись,</span>
						</h5>
						...
						<div className="ItemsWrp">
							...
							<div className="blockWraper">
								...
								<span className="caption">
									Загальний стан здоров’я відмінний
								</span>
							</div>
						</div>
					</div>
					<div className="block_documents">
						...
						<div className="twoCol">
							<div className="list">
								...
								<p>Посвідка на постійне проживання на без громадянства</p>
							</div>
